...
class Node:
    ...
    def predictOutcomeRecurse(self, case, a):
        if self.name == '':
            ...
            # Leaf nodes
            if self.label == '(Murder)':
                return '(Murder)'
            elif self.label == '(Theft)':
                return '(Theft)'
...
trainingPath = "C:\\Users\\mbhba\\Desktop\\Gmap\\Gmap\\AI project\\sampledata.txt"
...
##testingPath = "D:\Studying_Material\FYP\CODE\sampledata.txt"
